...
public class QRCodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        try {
            String url = "http://localhost:8080/ningyues_CSCI201_Final_Project/art_exhibition.html"; 
            String qrCodePath = qrGenerator.generateQRCode(url, "art_exhibition_qr.png");
